...
Taken from https://github.com/VarunPatelius/Py-iMessenger
*)
...
on run {targetPhoneNumber, targetMessageToSend}                         #When the file is called, ask for a phone number and the message that needs to be sent
    tell application "Messages"
        ...
        set targetMessage to targetMessageToSend                        #Set the intended message as the message that was passed in
